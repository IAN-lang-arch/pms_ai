...
# Load datasets
try:
    sym_des = pd.read_csv(os.path.join(current_dir,"datasets","description.csv"))
    precautions = pd.read_csv(os.path.join(current_dir,"datasets","precautions_df.csv"))
    workout = pd.read_csv(os.path.join(current_dir,"datasets","workout_df.csv"))
    description = pd.read_csv(os.path.join(current_dir,"datasets","description.csv"))
    medications = pd.read_csv(os.path.join(current_dir,"datasets",'medications.csv'))
    diets = pd.read_csv(os.path.join(current_dir,"datasets","diets.csv"))
except Exception as e:
    print(f"Error loading datasets: {e}")

# Load model
try:
    svc = pickle.load(open(os.path.join(current_dir,'svc.pkl'),'rb'))
except Exception as e:
...
def helper(dis):
    ...
    pre = [item for sublist in pre.values for item in sublist]
